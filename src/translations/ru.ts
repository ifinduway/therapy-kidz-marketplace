export const ru = {
  ...
  services: {
    ...
    description:
      "Мы предлагаем комплексные программы развития, разработанные с учетом индивидуальных потребностей каждого ребенка. Наши специалисты помогут вашему ребенку раскрыть свой потенциал и достичь успеха.",
    items: {
      speechTherapy: {
        title: "Логопедия",
        description:
